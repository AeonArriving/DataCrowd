...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
     ...
     <form action="/Spring-MVC-model/sjzbspgl/addSjzbSpgl" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator  encType="multipart/form-data" >
  <fieldset>
    <div class="am-form-group">
      <label for="doc-vld-name-2">商品名：</label>
      <input type="text" name="spm" id="doc-vld-name-2" required/>
    </div>
 ...
 <div class="am-form-group" >
	...
	<div class="am-form-group">
      ...
      <input type="text" name="dhjf" id="doc-vld-name-2" required/>
    </div>
    
     <div class="am-form-group">
      <label for="doc-vld-name-2">上架时间：</label>
      <input type="datetime-local" name="sjsj" class="am-form-field" placeholder="选择日期" data-am-datepicker  />
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">下架时间：</label>
      <input type="datetime-local" name="xjsj" class="am-form-field" placeholder="选择日期" data-am-datepicker  />
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">是否有效：</label>
      <input type="text" name="sfyx" id="doc-vld-name-2" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">起始总量：</label>
      <input type="text" name="qszl" id="doc-vld-name-2" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">存量：</label>
      <input type="text" name="cl" id="doc-vld-name-2" required/>
    </div>
