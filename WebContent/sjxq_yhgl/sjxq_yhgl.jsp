...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl>
          <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjxqyhgl/toAddSjxqYhgl">
  添加用户
</a>
        </dl>
        ...
        <div class="am-collapse am-topbar-collapse">
                <div class="am-collapse am-topbar-collapse">
                	<form id="search-form" action="<c:url value="/sjxqyhgl/yhgl"/>" class="am-topbar-form am-topbar-left am-form-inline" method="post" data-target="#table-container">
      ...
      <form class="am-form am-g">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          ...
          <tbody>
          <c:if test="${!empty sjxqyhList }"> 
          <c:forEach items="${sjxqyhList }" var="sjxqyh">  
            <tr>
              <td class="am-text-center">${sjxqyh.yhid }</td>  
                        <td class="am-text-center">${sjxqyh.yhm }</td>   
                        <td class="am-text-center">${sjxqyh.mm }</td>  
                        <td class="am-text-center">${sjxqyh.sj }</td>  
                        <td class="am-text-center">${sjxqyh.gs }</td>  
                        <td class="am-text-center">${sjxqyh.dz }</td>  
                        <td class="am-text-center">${sjxqyh.lxdh }</td>  
                        <td class="am-text-center">${sjxqyh.yx }</td>
                        <td class="am-text-center">${sjxqyh.yhms }</td>  
                        <td class="am-text-center">${sjxqyh.qx }</td>  
                        <td class="am-text-center">${sjxqyh.zt }</td>  
                        <td class="am-text-center">${sjxqyh.bz }</td>
              
              <td class="am-text-center"><div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjxqyhgl/getSjxqYhgl?id=${sjxqyh.yhid}">
  编辑
</a>
<a class="am-btn am-btn-danger" href="/Spring-MVC-model/sjxqyhgl/delSjxqYhgl?id=${sjxqyh.yhid}">
  删除
</a>
                  </div>
                </div></td>
