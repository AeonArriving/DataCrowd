...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
     ...
     <form action="/Spring-MVC-model/sjxqyhgl/updateSjxqYhgl" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
    <div class="am-form-group">
    <input type="hidden" name="yhid" value="${SjxqYhgl.yhid }">  
      <label for="doc-vld-name-2">用户名：</label>
      <input type="text" name="yhm" value="${SjxqYhgl.yhm }" id="doc-vld-name-2" minlength="3" placeholder="输入用户名（至少 3 个字符）" required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">用户密码：</label>
      <input type="password" name="mm" value="${SjxqYhgl.mm }" id="doc-vld-name-2" minlength="3" placeholder="输入用户密码（至少 3 个字符）" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">手机：</label>
      <input type="text" name="sj" value="${SjxqYhgl.sj }" id="doc-vld-name-2" minlength="11" placeholder="输入用户手机（至少 11 个字符）" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">用户所属公司：</label>
      <input type="text" name="gs" value="${SjxqYhgl.gs }" id="doc-vld-name-2" placeholder="输入用户所属公司" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">地址：</label>
      <input type="text" name="dz" value="${SjxqYhgl.dz }" id="doc-vld-name-2" placeholder="输入用户地址" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">联系电话：</label>
      <input type="text" name="lxdh" value="${SjxqYhgl.lxdh }" id="doc-vld-name-2"  placeholder="输入用户联系电话" required/>
    </div>
	
    <div class="am-form-group">
      <label for="doc-vld-email-2">邮箱：</label>
      <input type="email" name="yx" value="${SjxqYhgl.yx }" id="doc-vld-email-2" placeholder="输入邮箱" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">用户描述：</label>
      <input type="text" name="yhms" value="${SjxqYhgl.yhms }" id="doc-vld-name-2"  placeholder="输入用户描述" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">状态：</label>
      <input type="text" name="zt" value="${SjxqYhgl.zt }" id="doc-vld-name-2"  placeholder="输入用户状态( 0:有效；1：失效)" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">权限：</label>
      <input type="text" name="qx" value="${SjxqYhgl.qx }" id="doc-vld-name-2"  placeholder="输入用户权限( 0:任务分配管理员；1：接受任务一般用户)" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">备注：</label>
      <input type="text" name="bz" value="${SjxqYhgl.bz }" id="doc-vld-name-2"  required/>
    </div>
