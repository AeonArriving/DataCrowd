...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
     ...
     <form action="/Spring-MVC-model/sjzbyhgl/addSjzbYhgl" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
    ...
    <div class="am-form-group">
      ...
      <input type="text" name="dj" id="doc-vld-email-2" placeholder="输入用户等级" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-email-2">注册方式：</label>
      <input type="text" name="zcfs" id="doc-vld-email-2" placeholder="输入注册方式" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">现有积分：</label>
      <input type="text" name="jf" id="doc-vld-name-2" placeholder="输入用户现有积分" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">有效视频数量：</label>
      <input type="text" name="yxspsl" id="doc-vld-name-2" placeholder="输入用户有效视频数量" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">平均速度：</label>
      <input type="text" name="pjsd" id="doc-vld-name-2"  placeholder="输入用户平均速度" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">总里程：</label>
      <input type="text" name="zlc" id="doc-vld-name-2"  placeholder="输入用户总里程" required/>
    </div>
    
    <div class="am-form-group">
      <label for="doc-vld-name-2">平均里程：</label>
      <input type="text" name="pjlc" id="doc-vld-name-2"  placeholder="输入用户平均里程" required/>
    </div>
