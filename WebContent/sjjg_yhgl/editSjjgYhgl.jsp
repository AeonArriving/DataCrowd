...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
     ...
     <form action="/Spring-MVC-model/sjjgyhgl/updateSjjgYhgl" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
     <input type="hidden" name="yhid" value="${SjjgYhgl.yhid }">  
    <div class="am-form-group">
      <label for="doc-vld-name-2">用户名：</label>
      <input type="text" name="yhm" id="doc-vld-name-2" minlength="3" placeholder="输入用户名（至少 3 个字符）" value="${SjjgYhgl.yhm }" required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">用户密码：</label>
      <input type="password" name="mm" id="doc-vld-name-2" minlength="3" placeholder="输入用户密码（至少 3 个字符）" value="${SjjgYhgl.mm }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">手机：</label>
      <input type="text" name="sj" id="doc-vld-name-2" minlength="11" placeholder="输入用户手机（至少 11 个字符）" value="${SjjgYhgl.sj }" required/>
    </div>
	
    <div class="am-form-group">
      <label for="doc-vld-email-2">邮箱：</label>
      <input type="email" name="yx" id="doc-vld-email-2" placeholder="输入邮箱" value="${SjjgYhgl.yx }" required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">用户等级：</label>
      <input type="text" name="dj" id="doc-vld-name-2" placeholder="输入用户等级" value="${SjjgYhgl.dj }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">用户所属公司：</label>
      <input type="text" name="gs" id="doc-vld-name-2" placeholder="输入用户所属公司" value="${SjjgYhgl.gs }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">地址：</label>
      <input type="text" name="dz" id="doc-vld-name-2" placeholder="输入用户地址" value="${SjjgYhgl.dz }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">联系电话：</label>
      <input type="text" name="lxdh" id="doc-vld-name-2"  placeholder="输入用户联系电话" value="${SjjgYhgl.lxdh }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">用户描述：</label>
      <input type="text" name="yhms" id="doc-vld-name-2"  placeholder="输入用户描述" value="${SjjgYhgl.yhms }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">权限：</label>
      <input type="text" name="qx" id="doc-vld-name-2"  placeholder="输入用户权限( 0:任务分配管理员；1：接受任务一般用户)" value="${SjjgYhgl.qx }" required/>
    </div>
	...
	<div class="am-form-group">
      ...
      <input type="text" name="zt" id="doc-vld-name-2"  placeholder="输入用户状态( 0:有效；1：失效)" value="${SjjgYhgl.zt }" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">备注：</label>
      <input type="text" name="bz" id="doc-vld-name-2" value="${SjjgYhgl.bz }" required/>
    </div>
