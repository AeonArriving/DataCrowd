...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl>
          <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjjgyhgl/toAddSjjgYhgl">
  添加用户
</a>
        </dl>
        ...
        <div class="am-collapse am-topbar-collapse">
                <div class="am-collapse am-topbar-collapse">
                	<form id="search-form" action="<c:url value="/sjjgyhgl/yhgl"/>" class="am-topbar-form am-topbar-left am-form-inline" method="post" data-target="#table-container">
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <thead>
            <tr class="am-success">
              ...
              <th class="am-text-center">所属公司</th>
             <th class="am-text-center">地址</th>
              <th class="am-text-center">联系电话</th>
              <th class="am-text-center">用户描述</th>
              <th class="am-text-center">权限</th>
          ...
          <tbody>
          <c:if test="${!empty sjjgyhList }"> 
          <c:forEach items="${sjjgyhList }" var="sjjgyh">  
            <tr>
              <td class="am-text-center">${sjjgyh.yhid }</td>  
                        <td class="am-text-center">${sjjgyh.yhm }</td>   
                        <td class="am-text-center">${sjjgyh.mm }</td>  
                        <td class="am-text-center">${sjjgyh.dj }</td>  
                        <td class="am-text-center">${sjjgyh.gs }</td>  
                        <td class="am-text-center">${sjjgyh.dz }</td>  
                        <td class="am-text-center">${sjjgyh.lxdh }</td>  
                        <td class="am-text-center">${sjjgyh.yhms }</td>  
                        <td class="am-text-center">${sjjgyh.qx }</td>
                        <td class="am-text-center">${sjjgyh.cjrq }</td>  
                        
                        <td class="am-text-center">${sjjgyh.zt }</td>  
                        <td class="am-text-center">${sjjgyh.bz }</td>
              
              <td class="am-text-center"><div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjjgyhgl/getSjjgYhgl?id=${sjjgyh.yhid}">
  编辑
</a>
<a class="am-btn am-btn-danger" href="/Spring-MVC-model/sjjgyhgl/delSjjgYhgl?id=${sjjgyh.yhid}">
  删除
</a>
                  </div>
                </div></td>
