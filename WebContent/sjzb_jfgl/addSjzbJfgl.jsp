...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
     ...
     <form action="/Spring-MVC-model/sjzbjfgl/addSjzbJfgl" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
    <div class="am-form-group">
      <label for="doc-vld-name-2">积分等级：</label>
      <input type="text" name="jfdj" id="doc-vld-name-2" required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">等级需要达到的里程：</label>
      <input type="text" name="djlc" id="doc-vld-name-2" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">该等级单位积分：</label>
      <input type="text" name="dwjf" id="doc-vld-name-2" required/>
    </div>
