  ...
  <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;">
          当前位置： 首页 > <a href="#">积分管理</a>
        </dl>
       
        <!--data-am-modal="{target: '#my-popup'}" 弹出层 ID  弹出层 190行 开始  271行结束--> 
        
      </div>
     <form action="/Spring-MVC-model/sjzbjfgl/updateSjzbJfgl" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
      <input type="hidden" value="${SjzbJfgl.jfdj }" name="jfdj" id="doc-vld-name-2" required/>

	<div class="am-form-group">
      <label for="doc-vld-name-2">等级需要达到的里程：</label>
      <input type="text" value="${SjzbJfgl.djlc }" name="djlc" id="doc-vld-name-2" required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">该等级单位积分：</label>
      <input type="text" value="${SjzbJfgl.dwjf }" name="dwjf" id="doc-vld-name-2" required/>
    </div>
