  ...
  <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;">
          当前位置： 首页 > <a href="#">積分管理</a>
        </dl>
        <!--data-am-modal="{target: '#my-popup'}" 弹出层 ID  弹出层 190行 开始  271行结束--> 
        <dl>
          <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjzbjfgl/toAddSjzbJfgl">
  添加積分等級
</a>
        </dl>
      </div>
      <form class="am-form am-g">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <thead>
            <tr class="am-success">
              <th class="table-id am-text-center">積分等級</th>
              <th class="table-id am-text-center">等级需要达到的里程</th>
              <th class="table-id am-text-center">该等级单位积分</th>
              <th class="table-id am-text-center">操作</th>
            </tr>
          </thead>
          <tbody>
          <c:if test="${!empty sjzbjfglList }"> 
          <c:forEach items="${sjzbjfglList }" var="sjzbjf">  
            <tr>
              <td class="am-text-center">${sjzbjf.jfdj }</td>  
                        <td class="am-text-center">${sjzbjf.djlc }</td>   
                        <td class="am-text-center">${sjzbjf.dwjf }</td>  
              <td><div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjzbjfgl/getSjzbJfgl?jfdj=${sjzbjf.jfdj}">
  编辑
</a>
                  </div>
                </div></td>
