  ...
  <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;">
          当前位置： 首页 > <a href="#">数据存储管理</a>
        </dl>
       
        <!--data-am-modal="{target: '#my-popup'}" 弹出层 ID  弹出层 190行 开始  271行结束--> 
        
      </div>
     <form action="/Spring-MVC-model/sjzbsjcczlj/updateSjzbSjcczlj" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
  <input type="hidden" name="id" value="${sjcczlj.id }">  
    <div class="am-form-group">
      <label for="doc-vld-name-2">存储主路径：</label>
      <input type="text" name="cczlj" value="${sjcczlj.cczlj }" id="doc-vld-name-2" required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">采集数据时间间隔：</label>
      <input type="text" name="cjsjsjjg" value="${sjcczlj.cjsjsjjg }" id="doc-vld-name-2" required/>
    </div>
