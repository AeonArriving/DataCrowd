          ...
          <thead>
            <tr class="am-success">
             <th class="table-id am-text-center">序号</th>
              <th class="table-id am-text-center">存储主路径</th>
              <th class="table-id am-text-center">采集数据时间间隔</th>
              <th width="125px" class="table-id am-text-center">操作</th>
            </tr>
          </thead>
          <tbody>
          <c:if test="${!empty sjcczlj }"> 
          
            <tr>
            <td class="am-text-center">${sjcczlj.id }</td>  
              <td class="am-text-center">${sjcczlj.cczlj }</td>  
                        <td class="am-text-center">${sjcczlj.cjsjsjjg }</td>   
              <td class="am-text-center"><div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  <a class="am-btn am-btn-primary" href="/Spring-MVC-model/sjzbsjcczlj/editSjcczlj">
  编辑
</a>
                  </div>
                </div></td>
