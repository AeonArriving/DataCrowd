...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
     ...
     <ul>
      ...
      <h3 class="am-icon-cart-plus"><em></em> <a href="/Spring-MVC-model/sjzbyhgl/yhgl"> 数据采集管理</a></h3>
      <ul>
      ...
      <h3 class="am-icon-users"><em></em> <a href="/Spring-MVC-model/sjjgyhgl/yhgl">数据加工管理</a></h3>
      <ul>
        <li><a href="/Spring-MVC-model/sjjgyhgl/yhgl">用户管理</a> </li>
      </ul>
      <h3 class="am-icon-volume-up"><em></em> <a href="/Spring-MVC-model/sjjgyhgl/yhgl">数据标注管理</a></h3>
      <ul>
        
      </ul>
      <h3 class="am-icon-gears"><em></em> <a href="/Spring-MVC-model/sjxqyhgl/yhgl">数据需求管理</a></h3>
      <ul>
