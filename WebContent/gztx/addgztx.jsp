...
<div class=" admin-content">
  ...
  <div class="admin-biaogelist">
     ...
     <form action="/Spring-MVC-model/gztx/addgztx" method="post" class="am-form" style="width:550px;margin: 0 auto;" data-am-validator>
  <fieldset>
    <div class="am-form-group">
      <label for="doc-vld-name-2">标题：</label>
      <input type="text" name="bt" id="doc-vld-name-2" placeholder="输入标题"  required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">内容：</label>
     <textarea class="" rows="5" id="doc-ta-1" name="nr"></textarea>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">开始日期：</label>
      <input type="date" name="ksrq" id="doc-vld-name-2"  required/>
    </div>
	
    <div class="am-form-group">
      <label for="doc-vld-email-2">结束日期：</label>
      <input type="date" name="jsrq" id="doc-vld-email-2" required/>
    </div>

	<div class="am-form-group">
      <label for="doc-vld-name-2">有效标志（0：有效；1：不再提醒）：</label>
      <input type="text" name="yxbz" id="doc-vld-name-2"  required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">提醒用户类型（0：上传用户；1：数据加工对象；2：数据需求用户）：</label>
      <input type="text" name="txyhlx" id="doc-vld-name-2"   required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">提醒用户id（不同用户表中的id）：</label>
      <input type="text" name="txyhid" id="doc-vld-name-2"  required/>
    </div>
	
	<div class="am-form-group">
      <label for="doc-vld-name-2">发布人id：</label>
      <input type="text" name="fbrid" id="doc-vld-name-2" required/>
    </div>
